...
$lang = array_merge($lang, array(
	...
	'RS_DATE'					=> 'Дата',
	'RS_DETAILS'				=> 'Репутация пользователя',
	'RS_FROM'					=> 'От',
	'RS_LIST'					=> 'Список оценок',
	'RS_POST_COUNT'				=> 'Баллы за посты',
	...
	'RS_WEEK'					=> 'За неделю',
	'RS_MONTH'					=> 'За месяц',
	'RS_6MONTHS'				=> 'За 6 месяцев',
	'RS_NEGATIVE'				=> 'Отрицательные',
	'RS_POSITIVE'				=> 'Положительные',
	'RS_POINT'					=> 'Балл',
	'RS_POINTS'					=> 'Баллов',
	'RS_POST'					=> 'Пост',
	'RS_POST_DELETE'			=> 'Пост удален',
	'RS_POWER'					=> 'Reputation power',
	'RS_POST_RATING'			=> 'Оцененный пост',
	'RS_ONLYPOST_RATING'		=> 'Рассматриваемый пост',
	'RS_RATE_BUTTON'			=> 'Оценить',
	'RS_RATE_POST'				=> 'Оценить пост',
	...
	'RS_VIEW_DETAILS'			=> 'Подробнее',
	'RS_VOTING_POWER'			=> 'Remaing power points',
	'RS_WARNING'				=> 'Warning user',

	'RS_EMPTY_DATA'				=> 'Отсутствуют баллы репутации.',
	'RS_NA'						=> 'n/a',
	...
	'LIST_REPUTATION'				=> '1 репутация',
	'LIST_REPUTATIONS'				=> '%s репутаций',
	'ALL_REPUTATIONS'				=> 'Все репутации',
